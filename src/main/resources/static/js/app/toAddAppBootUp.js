...
$(function() {
	...
	$("#formSubmit").click(function(){
		...
		if (result){
			$.ajax({
	            url: basePath+'/app/addAppBootUp?bootUpName='+bootUpName+"&picturePath="+picturePath+"&bootUpYesOrNo="+bootUpYesOrNo
	            +"&startTimeStr="+startTime+"&endTimeStr="+endTime+"&operationState="+operationState,
	            type: 'POST', //GET
