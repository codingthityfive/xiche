...
var w_height = $(window).height()*0.85;
var grid_selector = "#grid-table";
var pager_selector = "#grid-pager";
$(document).ready(function () {
    var providerInfo=1;
    $("#grid-table").jqGrid({
        url: basePath+"/newChangjia/getPagePinpai?name=",
        jsonReader : {
            root:"result.list",
            page: "result.pageNum",
            total: "result.pages",
...
$("#appealBtn").click(function() {
	  top.dialog({
		url: basePath+'/changjia/toChangJiaAdd',
		title: '新增品牌厂家',
      width:1100,
      height:600,
...
function changjiaDia(pinpaichangjia) {
    ...
    top.dialog({
        url: basePath+'/first/shengchanchangjia?name='+pinpaichangjia,
        title:'甲方信息查询',
        width:w_width,
        height:w_height,
        data: {pinpai:pinpaichangjia}, // 给modal 要传递的 的数据
        onclose: function() {
